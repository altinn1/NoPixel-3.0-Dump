...
RegisterNetEvent('np-vehicles:spawnedGarageVehicle')
AddEventHandler('np-vehicles:spawnedGarageVehicle', function(pNetId, pModel)
    Citizen.Wait(1000)
...
Citizen.CreateThread(function()
    exports["np-keybinds-1"]:registerKeyMapping("", "Vehicle", "Toggle Neon Lights", "+toggleNeonLights", "-toggleNeonLights")
    exports["np-keybinds-1"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Right)", "+toggleRightIndicator", "-toggleRightIndicator")
    exports["np-keybinds-1"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Left)", "+toggleLeftIndicator", "-toggleLeftIndicator")
    exports["np-keybinds-1"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Hazard)", "+toggleHazardLights", "-toggleHazardLights")
end)
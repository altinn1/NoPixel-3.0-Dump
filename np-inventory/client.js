...
async function OpenGui() {
    ...
    const [fetchCash] = await RPC.execute("GetCurrentCash"); // TODO: Same with this, handle this server side
    cash = fetchCash;
    let [hasWeaponsLicense] = await RPC.execute("CheckLicenseForCharacter", cid, "Weapons License");

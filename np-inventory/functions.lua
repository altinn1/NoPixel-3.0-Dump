...
Citizen.CreateThread(function()
    exports["np-keybinds-1"]:registerKeyMapping("", "Vehicle", "Door Keyfob", "+useKeyFob", "-useKeyFob", "Y")
...
AddEventHandler('inv:lockPick', function(isForced,inventoryName,slot)
    ...
    if targetVehicle == 0 then
        ...
        if driverPed ~= 0 then
            ...
            local finished = exports["np-ui"]:taskBarSkill(25000, 3)
            ...
            local finished = exports["np-ui"]:taskBarSkill(5000,3)
            ...
            local finished = exports["np-ui"]:taskBarSkill(2000, 8)

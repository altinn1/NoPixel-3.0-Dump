...
Citizen.CreateThread(function()
  exports["np-keybinds-1"]:registerKeyMapping("", "ZZDev", "Menu", "+devMenu", "-devMenu")
  RegisterCommand('+devMenu', devMenu, false)
  RegisterCommand('-devMenu', function() end, false)
  
  exports["np-keybinds-1"]:registerKeyMapping("", "ZZDev", "Noclip", "+devNoclip", "-devNoclip", "F2")
  RegisterCommand('+devNoclip', devNoclip, false)
  RegisterCommand('-devNoclip', function() end, false)
  
  exports["np-keybinds-1"]:registerKeyMapping("", "ZZDev", "Cloak", "+devCloak", "-devCloak", "F3")
  RegisterCommand('+devCloak', devCloak, false)
  RegisterCommand('-devCloak', function() end, false)
  
  exports["np-keybinds-1"]:registerKeyMapping("", "ZZDev", "Marker Teleport", "+devMarker", "-devMarker","F6")

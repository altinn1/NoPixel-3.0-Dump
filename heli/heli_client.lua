...
function heliVision()
	...
	if helicam and not IsEntityDead(lPed) and (GetVehiclePedIsIn(lPed) == heli) and IsHeliHighEnough(heli) then
		PlaySoundFrontend(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", false)
		ChangeVision()
	end
end
...
Citizen.CreateThread(function()
  exports["np-keybinds-1"]:registerKeyMapping("","Heli", "Cam", "+heliCam", "-heliCam")
  RegisterCommand('+heliCam', heliCam, false)
  RegisterCommand('-heliCam', function() end, false)
  
  exports["np-keybinds-1"]:registerKeyMapping("","Heli", "Vision", "+heliVision", "-heliVision")
  RegisterCommand('+heliVision', heliVision, false)
  RegisterCommand('-heliVision', function() end, false)
  
  exports["np-keybinds-1"]:registerKeyMapping("","Heli", "Rappel", "+heliRappel", "-heliRappel")
  RegisterCommand('+heliRappel', heliRappel, false)
  RegisterCommand('-heliRappel', function() end, false)
  
  exports["np-keybinds-1"]:registerKeyMapping("","Heli", "Spotlight", "+heliSpot", "-heliSpot")
  RegisterCommand('+heliSpot', heliSpot, false)
  RegisterCommand('-heliSpot', function() end, false)
  
  exports["np-keybinds-1"]:registerKeyMapping("","Heli", "Lock On", "+heliLock", "-heliLock")
